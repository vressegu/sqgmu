function buoy_scrambl = ens_Scramble(model)
%% buoy_scrambl = ens_Scramble(model)
...
% with expected .init attributes:   
%   - resolution_ratio: the high_res/low_res resolution ratio;
