function error_vs_t = post_process_error_grid_save(stochastic_simulation,...
...
%         end
        %%
        % Plots
        [spectrum,name_plot] = fct_plot(model,fft_buoy_part,day);
...
%         end
       ...
       temp(1,1) = ...
        ...
        temp(1,2) = ...
            ...
            sum(abs(fft_buoy_part(:) - fft_buoy_part_ref(:)).^2) ;
        % Concatenation
