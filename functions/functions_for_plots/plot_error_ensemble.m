...
% colormap jet
subplot(1,2,1)
imagesc(model.grid.x,model.grid.y,(abs(error_mean(:,:,:,id_part)')/odgT));
...
[~,name_plot] = fct_spectrum53_HR_error( ...
    model_randomIC,fft2(error_mean_classic)/odgT,'r+-');
...
set(name_plot,'LineWidth',LineWidth,...
    ...
    'Color',Color2);
[~,name_plot] = fct_spectrum53_HR_error( ...
    model,fft2(estim_error_classic)/odgT,'ro-');
set(name_plot,'LineWidth',LineWidth,...
    'MarkerSize',MarkerSize,...
    'Color',Color2);
