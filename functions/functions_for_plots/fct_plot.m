...
if plot_moments
    ...
    set(figure2,'Units','inches', ...
        ...
        'PaperPositionMode','auto');
    subplot(1,2,1)
    imagesc(x,y,mean_T(:,1:My)');axis xy;
    axis equal
    caxis([-1 1]*1e-3);
    colorbar
    set(gca,...
    ...
    subplot(1,2,2)
    imagesc(x,y,std_T(:,1:My)');axis xy;
    axis equal
    caxis([0 1.5e-4]);
    if strcmp(type_data,'Spectrum')
        caxis([0 1e-3]);
    ...
    subplot(1,2,2)
    imagesc(x,y,log(m4(:,1:My)'-3));axis xy;
    axis equal
    colorbar
    set(gca,...
        'Units','normalized',...
