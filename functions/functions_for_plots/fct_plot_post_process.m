function [spectrum,name_plot,int_epsilon] = fct_plot_post_process(model,fft_b_adv_part,day)
...
%         'FontName','Times')
    ...
    xlabel('x(m)',...
        ...
        'FontName','Times')
%     title('Mean',...
    % %     title(['\hspace{1.5cm} Mean $t=' num2str(day) '$ day'],...
    title({['$t=' num2str(day) '$ day'], ...
        '\hspace{0.7cm} Mean'},...
        'FontUnits','points',...
        'FontWeight','normal',...
    ...
    subplot(2,2,2)
    imshow((std_T').^2);
    imagesc(x,y,(std_T').^2);axis xy;
    axis equal
    %caxis([0 model.odg_b/(1e-3)*1.5e-4]);
    caxis([0 1e-8]);
    %     if strcmp(type_data,'Spectrum')
    %         caxis([0 (model.odg_b/(1e-3)*1e-3)^2]);
    %     else
    %         caxis([0 (model.odg_b/(1e-3)*1.5e-4)^2 ]);
    %     end
    % %     if strcmp(type_data,'Spectrum')
    ...
    xlabel('x(m)',...
        ...
        'FontSize',taille_police,...
        'FontName','Times')
    %     title('\hspace{1cm} St. dev.',...
    title('\hspace{1cm} Variance',...
        'FontUnits','points',...
        'FontWeight','normal',...
        'interpreter','latex',...
        'FontSize',12,...
